    ...
    <el-row>
      ...
      <el-col :span="16">
        ...
        <div class="form-design" @drop="drop" @dragover="allowDrop">
          <quick-form :model="formDesignConfig.form" :form-items="formDesignConfig.formItems" :hidden-action="true">
          </quick-form>
        </div>
      </el-col>
      <el-col :span="4">
            ...
            <el-tab-pane label="表单属性" name="first">
              <div class="wrap">
                <div class="item">
                  ...
                  <div class="value">
                    <el-radio-group v-model="formAttributeConfig.layout" size="large">
                ...
                <div class="item">
                  ...
                  <div class="value">
                    <el-radio-group v-model="formAttributeConfig.labelAlign" size="large">
            ...
            <el-tab-pane label="字段属性" name="second">
              <div class="wrap">
                <div class="item">
                  ...
                  <div class="value">
                    <el-input v-model="fieldAtttributeConfig.id" :readonly="true" />
                  </div>
                </div>
                <div class="item">
                  <div class="title">类型</div>
                  <div class="value">
                    <el-input v-model="fieldAtttributeConfig.type" :readonly="true" />
                  </div>
                </div>
                <div class="item">
